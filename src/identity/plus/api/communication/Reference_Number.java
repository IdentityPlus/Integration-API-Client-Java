 ...
 */
public class Reference_Number extends API_Response{
    private static final long serialVersionUID = 1L;
    
    /**
     * The JSON Name of this response object as returned by the ReST API
     */
    public static final String JSON_NAME = Identity_Plus_Utils.json_name(Reference_Number.class);
    ...
    public Reference_Number(Outcome response, String value) {
        super(response);
        this.value = value;
    }
     ...
     */
    public Reference_Number(JsonObject object){
