 ...
 */
public class Service_Agent_Identity extends API_Response{
    private static final long serialVersionUID = 1L;
    
    /**
     * The JSON Name of this response object as returned by the ReST API
     */
    public static final String JSON_NAME = Identity_Plus_Utils.json_name(Service_Agent_Identity.class);
    ...
    public Service_Agent_Identity(Outcome response, byte[] p12, String password, byte[] certificate, byte[] private_key) {
        super(response);
        this.p12 = p12;
     ...
     */
    public Service_Agent_Identity(JsonObject object){
